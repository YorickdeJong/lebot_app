...
import CodeEditorScreen from './CodeEditor';
import Icon from '../../Icon';

function CodingQuestions({isFocused}){
    ...
    <LinearGradient
        ...
        >
            ...
            >
                    {isFocused && <CodeEditorScreen close = {close}/>}
                    {!close ? 
                    <>
                    <TextDisplay 
                    title="Codeer Vragen"
...
export default React.memo(CodingQuestions)
